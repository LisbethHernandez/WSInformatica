 ...
 * generated in the suma.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sumar_QNAME = new QName("http://server.suma/", "Sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://server.suma/", "SumarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: suma.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.suma/", name = "Sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.suma/", name = "SumarResponse")
